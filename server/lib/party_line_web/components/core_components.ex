defmodule PartyLineWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PartyLineWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PartyLineWeb.Gettext, "errors", msg, opts)
    end
  end
