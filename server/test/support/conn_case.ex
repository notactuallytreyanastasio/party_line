defmodule PartyLineWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use PartyLineWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      use PartyLineWeb, :verified_routes

      # Import conveniences for testing with connections
      import Plug.Conn
      import Phoenix.ConnTest
      import PartyLineWeb.ConnCase
    end
  end
