...
config :party_line, PartyLineWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: PartyLineWeb.ErrorHTML, json: PartyLineWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: PartyLine.PubSub,
  live_view: [signing_salt: "8/KxGCx5"]
...
config :party_line, PartyLine.Mailer, adapter: Swoosh.Adapters.Local
