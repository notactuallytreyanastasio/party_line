...
#
#     PHX_SERVER=true bin/party_line start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :party_line, PartyLineWeb.Endpoint, server: true
end

# Don't let PORT stomp the test env's fixed port (4002): the bot-socket
# integration tests dial a real listener there.
  ...
  config :party_line, PartyLineWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/party_line_web/router\.ex$"E,
        ~r"lib/party_line_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
...
if config_env() == :prod do
  ...
  config :party_line, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :party_line, PartyLine.Mailer,
